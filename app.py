...
def extraer_datos_profesional(pdf_file):
    ...
    # 1. EXPORTADOR E IMPORTADOR (Solo la primera línea/nombre)
    # Busca 'Remitente' (Campo 33 o 1) y toma la línea siguiente
    ...
    # Busca 'Destinatario' (Campo 34 o 4) y toma la línea siguiente
    ...
    # 4. VALOR (Campo 14 o 27: Valor / Valor)
    ...
    # 6. ADUANA DESTINO (Campo 8: Destino final)
    ...
    # 7. MIC Y CRT (Identificadores oficiales)
